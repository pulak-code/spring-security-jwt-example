...
public class SecurityProperties {
    ...
    public static class Auth {
         ...
         * Reads from environment variable SECURITY_JWT_SECRET_KEY first,
         * then falls back to security.auth.secret-key property.
         */
        @NotEmpty(message = "Secret key cannot be empty")
        @Size(min = 32, message = "Secret key must be at least 32 characters long")
        private String secretKey = System.getenv("SECURITY_JWT_SECRET_KEY");

        /**
         * Refresh token secret key.
         * Must be at least 32 characters in production.
         * Reads from environment variable SECURITY_JWT_REFRESH_SECRET_KEY first,
         * then falls back to security.auth.refresh-secret-key property.
         */
        @NotEmpty(message = "Refresh secret key cannot be empty")
        @Size(min = 32, message = "Refresh secret key must be at least 32 characters long")
        private String refreshSecretKey = System.getenv("SECURITY_JWT_REFRESH_SECRET_KEY");
